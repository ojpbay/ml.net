...
namespace Ml.netML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Oli\source\repos\ml.net\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../Ml.netML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 5E-06f, ConvergenceTolerance = 1E-05f, NumberOfIterations = 5, Shuffle = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
